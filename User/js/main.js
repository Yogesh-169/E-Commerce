        ...
        if ($button.text() === "+") {
            ...
            $.ajax({
                ...
                success: function(subcategory) {
                    ...
                    // location.assign("cart.php")
                    $("#totalprice".concat(cartId)).html("Rs. ".concat(total * newVal));
                    addtotalamount();
...
//             }
//             jQuery('cart-item-count').html(result);
//         }
//     });
// }
