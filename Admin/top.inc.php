                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                            <img width="42" class="rounded-circle" src="assets/images/head.jpg" alt="">
                                                    ...
                                                    <div class="menu-header-content text-left">
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                ...
                                                                <button class="btn-pill btn-shadow btn-shine btn btn-focus"><a href="logout.php">Logout</a></button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="no-gutters row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <button class="btn-icon-vertical btn-transition btn-transition-alt pt-2 pb-2 btn btn-outline-warning">
                                                            <i class="pe-7s-chat icon-gradient bg-amy-crisp btn-icon-wrapper mb-2"></i> Change Password
                                                        </button>
                                                    </div>
                                                    <div class="col-sm-6">
                        ...
                        <ul class="vertical-nav-menu">
                            ...
                            <li >
                                <a href="categories.php">
                                    <i class="metismenu-icon pe-7s-browser"></i>Categories Master
                                    <i class="metismenu-state-icon  caret-left"></i>
                                </a>
                            ...
                            <li  
                                   >
                                <a href="product.php">
                                    <i class="metismenu-icon pe-7s-plugin"></i>Product Master
                                    <i class="metismenu-state-icon caret-left"></i>
                                </a>
                                    ...
                                    <li >
                                        <a href="order.php">
                                            <i class="metismenu-icon pe-7s-note2"></i>Order Master
                                            <i class="metismenu-state-icon  caret-left"></i>
                                        </a>
                                    ...
                                    <li >
                                        <a href="orderdetail.php">
                                            <i class="metismenu-icon pe-7s-note2"></i>Order Details
                                            <i class="metismenu-state-icon  caret-left"></i>
                                        </a>
                                    ...
                                    <li >
                                        <a href="users.php">
                                            <i class="metismenu-icon pe-7s-user"></i>User Master
                                            <i class="metismenu-state-icon  caret-left"></i>
                                        </a>
                                    ...
                                    <li >
                                        <a href="contact_us.php">
                                            <i class="metismenu-icon pe-7s-headphones"></i>Contact Us
                                            <i class="metismenu-state-icon  caret-left"></i>
                                        </a>
