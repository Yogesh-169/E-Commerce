                                ...
                                <div class="col-sm-12 col-md-4 col-xl-4">
                                    <div class="card no-shadow rm-border bg-transparent widget-chart text-left">
                                        ...
                                        <div class="widget-chart-content">
                                            ...
                                            <div class="widget-numbers text-success"><span>RS.563</span></div>
                                                        ...
                                                        <div class="widget-chat-wrapper-outer">
                                                            <div class="widget-chart-content widget-chart-content-lg pb-0">
                                                                ...
                                                                <div class="widget-numbers">
                                                                    <div class="widget-chart-flex">
                                                                        <div>
                                                                            <small class="opacity-3 pr-1">RS.</small>
                                                                            <span>629</span>
                                        ...
                                        <div class="widget-chart-content pt-3 pl-3 pb-1">
                                            <div class="widget-chart-flex">
                                                <div class="widget-numbers">
                                                    <div class="widget-chart-flex">
                                                        <div class="fsize-4">
                                                            <small class="opacity-5">RS.</small>
                                                            <span>874</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <li class="list-group-item">
                                                        ...
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                ...
                                                                <div class="widget-content-left mr-3">
                                                                    <div class="widget-content-left">
                                                                        <img width="42" class="rounded" src="assets/images/head.jpg" alt="">
                                                                    </div>
                                                                </div>
                                                                <div class="widget-content-left">
                                                ...
                                                <div class="widget-content p-0">
                                                    <div class="widget-content-outer">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-right">
                                                                <div class="widget-numbers text-primary">RS.12.6k</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="widget-content p-0">
                                                    <div class="widget-content-outer">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-right">
                                                                <div class="widget-numbers text-warning">RS.3M</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
