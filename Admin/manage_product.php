							...
							<div class="card-body card-block">
							   <div class="form-group">
								...
								<div class="form-group">
									...
									<input type="text" id="name" name="mrp" placeholder="Enter product mrp" class="form-control" required value="<?php echo $mrp?>">
								</div>
								...
								<div class="form-group">
									...
									<input type="text" id="qty" name="qty" placeholder="Enter qty" class="form-control" required value="<?php echo $qty?>">
								</div>
								<script>
